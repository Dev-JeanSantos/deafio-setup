...
class ContaService(
    ...
    override fun processar(valor: BigDecimal, debito: CorrentistaModel, credito: CorrentistaModel): CorrentistaResponse {
        ...
        return correntistaRepositorioPorta.transferirValoresEntreContas(debitoNovoSaldo, creditoNovoSaldo).toResponse()
    }
}
